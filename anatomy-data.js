...
const ANATOMY_DATA = {
  ...
  herbSupport: {
    'ginger': {
      primary: ['liver', 'stomach', 'pancreas', 'small_intestine', 'large_intestine', 'heart', 'blood_vessel', 'brain'],
      secondary: ['lungs', 'trachea', 'kidneys', 'bladder'],
