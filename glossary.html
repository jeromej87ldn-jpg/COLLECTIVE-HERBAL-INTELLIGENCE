...
`;
  ...
  'capsule': {l:'Capsule',d:'Ground or powdered herb sealed inside a gelatin or plant-based shell. Masks taste entirely — which matters for bitters, since their digestive effect is partly triggered by the taste itself. Convenient and precisely dosed, but slower-acting than a tincture.'},
  ...
  // Additional compound-related terms
  'curcumin': {l:'Curcumin',d:'The primary bioactive compound in turmeric root. A polyphenol with potent anti-inflammatory and antioxidant action. Inhibits NF-κB and COX-2 pathways; alone is poorly bioavailable but piperine increases absorption 2,000-fold.'},
  'quercetin': {l:'Quercetin',d:'A bioflavonoid found in apples, red onions, berries and capers. Stabilizes mast cells (reducing allergic reactions), inhibits histamine release, and activates Nrf2 for antioxidant protection. One of the most studied plant flavonoids.'},
  'apigenin': {l:'Apigenin',d:'A flavonoid in chamomile, celery and parsley. Binds GABA-A receptors (promoting calm without sedation) and has neuroprotective effects. Studied for anxiety and cognitive support.'},
  'luteolin': {l:'Luteolin',d:'A flavonoid in oregano, thyme and celery. Inhibits pro-inflammatory cytokines and stabilises mast cells. Crosses the blood-brain barrier and protects against neuroinflammation.'},
  'berberine': {l:'Berberine',d:'An alkaloid in goldenseal, barberry and Oregon grape root. Activates AMPK (metabolic switch), inhibits bacterial lipopolysaccharides, modulates glucose metabolism and supports cardiovascular health. Potency comparable to some pharmaceuticals.'},
  'capsaicin': {l:'Capsaicin',d:'The pungent alkaloid in chili peppers. Activates TRPV1 receptors (sensing heat and pain), depletes substance P neuropeptide, and reduces pain signals. Also increases thermogenesis and fat burning.'},
  'piperine': {l:'Piperine',d:'The alkaloid that makes black pepper pungent. Inhibits CYP3A4 enzymes, dramatically increasing bioavailability of fat-soluble compounds — increases turmeric absorption by 2,000%. Also a thermogenic and anti-inflammatory agent.'},
  'cinnamaldehyde': {l:'Cinnamaldehyde',d:'The compound giving cinnamon its smell and taste. Modulates TRPV3 ion channels, supports blood glucose regulation and has antimicrobial action. Compounds the warming/circulatory effects of cinnamon.'},
  'carvacrol': {l:'Carvacrol',d:'Monoterphenol found in oregano and thyme essential oils. Powerful antimicrobial and antispasmodic — disrupts bacterial cell membranes and relaxes smooth muscle. Must be used cautiously due to potency.'},
  ...
  'farnesol': {l:'Farnesol',d:'Sesquiterpene alcohol found in frankincense and rose. Antimicrobial, anti-inflammatory and neuroprotective. Activates farnesoid X receptor affecting bile acid metabolism and immune homeostasis.'},
  'cedrol': {l:'Cedrol',d:'Sesquiterpene in cedarwood essential oil. Antimicrobial, calming and grounding. Traditional use in meditation; modern research shows it modulates immune response and nervous system.'},
  'ursolic acid': {l:'Ursolic Acid',d:'Triterpenoid found in apple peels, rosemary and basil. Activates AMPK (metabolic switch), inhibits NF-κB, promotes myogenesis and supports muscle maintenance. Anti-inflammatory and antitumor properties.'},
  'oleanolic acid': {l:'Oleanolic Acid',d:'Triterpenoid in olive leaves and garlic. Hepatoprotective, anti-inflammatory and immunomodulating. Inhibits viral protease and enhances interferon production, making it antivirally relevant.'},
  'carnosic acid': {l:'Carnosic Acid',d:'Diterpene in rosemary. Activates Nrf2 pathway for powerful antioxidant and neuroprotective effects. Also antimicrobial and anti-inflammatory. Converts to carnosol when heated.'},
  'carnosol': {l:'Carnosol',d:'Oxidized form of carnosic acid, created when rosemary is heated. Potent antioxidant, neuroprotective and anti-inflammatory. More stable than carnosic acid; bioavailable form of rosemary\'s benefits.'},
  'gingerol': {l:'Gingerol',d:'Pungent compound in fresh ginger root. Inhibits COX-2 and 5-LOX inflammation pathways; activates TRPV1 receptors (thermogenic); supports digestion and reduces nausea. Converts to shogaol when dried/heated.'},
  'shogaol': {l:'Shogaol',d:'Dehydrated form of gingerol, created when ginger is dried or cooked. More potent than gingerol; thermogenic and immunomodulating. Responsible for the extra "heat" and warming effect of dried ginger.'},
  'piperamide': {l:'Piperamide',d:'Alkaloid related to piperine, found in black pepper. Enhances nutrient bioavailability and supports thermogenesis. Works synergistically with piperine for metabolic support.'},
  'sesamin': {l:'Sesamin',d:'Lignan in sesame seeds. Activates PPARα (regulates lipid metabolism), inhibits hepatic fatty acid synthesis and supports liver health. Also neuroprotective and anti-inflammatory.'},
  'sesamol': {l:'Sesamol',d:'Polyphenol in sesame oil and seeds. Potent antioxidant and hepatoprotective. Inhibits lipid peroxidation and supports antioxidant enzyme production via Nrf2 activation.'},
  'punicalagin': {l:'Punicalagin',d:'Ellagitannin in pomegranate fruit and rind. Breaks down to urolithin A by gut bacteria — activates mitophagy (cellular cleanup). Antioxidant and cardioprotective; studied for longevity.'},
  'urolithin a': {l:'Urolithin A',d:'Metabolite of ellagic acid (from pomegranate, raspberry). Activates mitophagy — removes damaged mitochondria and improves cellular energy. One of the most researched anti-aging compounds; enhances strength and endurance.'},
  'resveratrol': {l:'Resveratrol',d:'Polyphenol in red grapes and berries. Activates sirtuins (aging-regulatory proteins) and AMPK; cardioprotective and neuroprotective. Modulates inflammation genes and supports longevity pathways.'},
  'anthocyanin': {l:'Anthocyanin',d:'Water-soluble pigment in red, purple and blue plants. Powerful antioxidant and anti-inflammatory; crosses blood-brain barrier. Supports vision, cognition and cardiovascular health; found in blueberry, hawthorn and hibiscus.'},
  'proanthocyanidin': {l:'Proanthocyanidin',d:'Oligomeric flavonoid in grape seed, pine bark and hawthorn. Powerful vascular strengthener — stabilizes collagen and elastin in blood vessel walls. Supports blood flow and vessel integrity better than single anthocyanins.'},
  'chlorogenic acid': {l:'Chlorogenic acid',d:'Polyphenol in green coffee beans and dandelion. Inhibits glucose-6-phosphatase (slows glucose absorption), activates AMPK and has hepatoprotective effects. Also a powerful antioxidant and neuroprotective.'},
  'caffeic acid': {l:'Caffeic Acid',d:'Phenolic acid in many herbs and coffee. Anti-inflammatory via NF-κB inhibition; antimicrobial and neuroprotective. Often found alongside chlorogenic acid in plants.'},
  'quinic acid': {l:'Quinic Acid',d:'Organic acid in dandelion, chicory and celery. Supports liver detoxification, promotes beneficial gut bacteria and has hepatoprotective properties. A precursor to chlorogenic acid in some plants.'},
  'catechin': {l:'Catechin',d:'Flavanol in green tea, white tea and cacao. Powerful antioxidant and hepatoprotective. EGCG (a catechin) is the most studied green tea compound for metabolism and cancer prevention.'},
  'egcg': {l:'EGCG (Epigallocatechin Gallate)',d:'Most abundant and studied catechin in green tea. Activates AMPK and Nrf2 pathways; thermogenic; supports metabolism and cardiovascular health. Bioavailability improved by vitamin C and lemon.'},
  'theaflavin': {l:'Theaflavin',d:'Oxidized catechin found in black tea (not in green tea). Cardioprotective, anti-inflammatory and supports cholesterol metabolism. Creates black tea\'s dark color and unique benefits.'},
  'thearubigin': {l:'Thearubigin',d:'Polymer of oxidized catechins in black and oolong tea. Powerful antioxidant and anti-inflammatory; supports cardiovascular and gut health. Responsible for tea\'s astringency and color.'},
  'ecdysteroid': {l:'Ecdysteroid',d:'Plant-derived compound mimicking insect molting hormones. Found in some herbs (spinach, nettle); supports muscle protein synthesis and anabolic processes without hormonal side effects studied in athletes.'},
  'steroidal compound': {l:'Steroidal Compound',d:'Plant-derived molecule structurally similar to steroid hormones. Withanolides in ashwagandha and furostanol saponins in fenugreek are examples; modulate hormone receptors without being actual hormones.'},
  'ginsenoside': {l:'Ginsenoside',d:'Dammarane triterpenoid saponin unique to ginseng (Panax species). Over 40 known types with different ratios in red vs white ginseng. Adaptogens that modulate cortisol; immunomodulating and neuroprotective.'},
  'eleutherococcus': {l:'Eleutheroside',d:'Adaptogenic lignan and polysaccharide in eleuthero root (Siberian ginseng). Distinct from ginsenosides; enhances stamina and stress resistance. Polysaccharides activate immune function.'},
  'valepotriate': {l:'Valepotriate',d:'Iridoid ester in valerian root. Rapidly broken down to isovalerates by digestive enzymes; acts on GABA and adenosine receptors for sedative effect. More potent than the parent compounds.'},
  'acteoside': {l:'Acteoside',d:'Phenylethanoid glycoside in plantain leaf and lemon balm. Neuroprotective, anti-inflammatory and antioxidant. Crosses blood-brain barrier and protects dopamine neurons.'},
  'verbascoside': {l:'Verbascoside',d:'Phenylethanoid glycoside in mullein, verbena and lemon balm. Anti-inflammatory, antimicrobial and immunomodulating. Inhibits NF-κB activation and pro-inflammatory cytokine production.'},
  'luteoline': {l:'Luteoline',d:'Bioflavone variant with similar properties to luteolin. Found in several herbs; crosses blood-brain barrier; supports cognitive function and neuroinflammation management.'}
  };
